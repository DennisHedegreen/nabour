...
PAIR_SPECS = {
    "dk_se": PairSpec(
        ...
        labels={"en": "Denmark ↔ Sweden", "da": "Danmark ↔ Sverige", "sv": "Danmark ↔ Sverige"},
    ...
    "dk_no": PairSpec(
        ...
        labels={"en": "Denmark ↔ Norway", "da": "Danmark ↔ Norge", "sv": "Danmark ↔ Norge"},
    ...
    "se_no": PairSpec(
        ...
        labels={"en": "Sweden ↔ Norway", "da": "Sverige ↔ Norge", "sv": "Sverige ↔ Norge"},
